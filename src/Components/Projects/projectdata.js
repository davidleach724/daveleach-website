export const projectdata = [
  ...
  },
  {
    ...
    accomplishments:
      'Self-teaching Context API and implementing global state management',
  ...
  },
  {
    ...
    image: 'bandglamp.jpg',
    summary:
      'A showcase application that allows artists/bands book campsites corresponding to their tour',
  ...
  },
  {
    ...
    accomplishments:
      'Creating an application with focus on CSS and cross browser compatibility',
  ...
  },
  {
    ...
    accomplishments:
      'Created an application with the React framework, integrated React Router, Asynchronous JS, Cypress testing',
  ...
  },
  {
    ...
    image: 'travelon.jpg',
    summary:
      'An application to manage, book, and display different trips for a user database',
    tech: 'JavaScript, HTML5, CSS/SCSS, NODE, WebPack, Fetch API, Moment.js',
    accomplishments:
      'GET and POST data from an API, built a robust test suite for happy/sad paths, designed all graphics on page',
    deployedLink: '',
